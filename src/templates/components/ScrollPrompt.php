<section class="scroll-prompt" data-scroll-prompt>
  <article>
    <svg class="scroll-prompt__icon" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
    ...
    <p class="scroll-prompt__text">Scroll For More</p>
  </article>
</section>